...
receiver.OnInvoke = function(btn) 
	if btn == "YES" then
		remote = game:GetService("ReplicatedStorage"):WaitForChild("ALLREMBINDS"):WaitForChild("MainRemoteEvent")
		enable = true
		sent = true
		found = true
		load()
...
if remote == "nil" then
	StarterGui:SetCore("SendNotification", {
		Title = "DO YOU WANT TO RUN SCRIPT OR NO";
		Text = "";
		Duration = 9e9;
		Button1 = "YES";
		Callback = receiver;
...
function work(arg1)
	pcall(function() 
		remote:FireServer("EMMFOSS__!ZCNSJNXCSDWQSANBX", "ChangeProptyOfSmtHSH", {arg1, "Parent", nil})
	end)
end
...
function load()
	...
	if enable == true then
        ...
        local url = "https://raw.githubusercontent.com/BaconBABA/script/refs/heads/main/web.lua"
        local StarterGui = game:GetService("StarterGui")
        ...
        if not success then
            ...
            StarterGui:SetCore("SendNotification", {
                ...
                Text = "https://discord.gg/8pJCFW8cpG",
                Duration = 5 
            })
        end
